...
static inline rv_uint_xlen rv_core_decode(rv_core_td *rv_core)
{
    ...
    rv_core->execute_instr = INSTR_NOP_EX ;
    ...
    case   INSTR_LUI  :
    {
        ...
        //[INSTR_JAL] = {J_type_preparation, instr_JAL, NULL},
        int32_t next_subcode = -1;
        U_type_preparation(rv_core, &next_subcode);
        //rv_core->execute_cb =instr_LUI;
        rv_core->execute_instr = INSTR_LUI_EX;
        break ;
    }
    ...
    case   INSTR_AUIPC  :
    {
        ...
        int32_t next_subcode = -1;
        U_type_preparation(rv_core, &next_subcode);
        //rv_core->execute_cb =instr_AUIPC;
        rv_core->execute_instr = INSTR_AUIPC_EX;
    ...
    case   INSTR_JAL  :
    {
        ...
        //[INSTR_JAL] = {J_type_preparation, instr_JAL, NULL},
        int32_t next_subcode = -1;
        J_type_preparation(rv_core, &next_subcode);
        //rv_core->execute_cb =instr_JAL;
        rv_core->execute_instr = INSTR_JAL_EX;
        break ;
    }
    case   INSTR_JALR  :
    {
        ...
        int32_t next_subcode = -1;
        I_type_preparation(rv_core, &next_subcode);

        switch ( next_subcode )
        {
        case   FUNC3_INSTR_JALR  :
            //rv_core->execute_cb =instr_JALR;
            rv_core->execute_instr = INSTR_JALR_EX;
            break;
        default:
            break;
        }
    ...
    case   INSTR_BEQ_BNE_BLT_BGE_BLTU_BGEU  :
    {
        ...
        int32_t next_subcode = -1;
        B_type_preparation(rv_core, &next_subcode);

        switch ( next_subcode )
        {

        case   FUNC3_INSTR_BEQ  :
            //rv_core->execute_cb =instr_BEQ;
            rv_core->execute_instr = INSTR_BEQ_EX;
            break;
        case   FUNC3_INSTR_BNE  :
            //rv_core->execute_cb =instr_BNE;
            rv_core->execute_instr = INSTR_BNE_EX;
            break;
        case   FUNC3_INSTR_BLT  :
            //rv_core->execute_cb =instr_BLT;
            rv_core->execute_instr = INSTR_BLT_EX;
            break;
        case   FUNC3_INSTR_BGE  :
            //rv_core->execute_cb =instr_BGE;
            rv_core->execute_instr =INSTR_BGE_EX;
            break;
        case   FUNC3_INSTR_BLTU  :
            //rv_core->execute_cb =instr_BLTU;
            rv_core->execute_instr =INSTR_BLTU_EX ;
            break;
        case   FUNC3_INSTR_BGEU  :
            //rv_core->execute_cb =instr_BGEU;
            rv_core->execute_instr =INSTR_BGEU_EX ;
            break;
        default:
            break;
        }
    ...
    case   INSTR_LB_LH_LW_LBU_LHU_LWU_LD  :
    {
        ...
        case   FUNC3_INSTR_LB  :
            //rv_core->execute_cb =instr_LB;
            rv_core->execute_instr =INSTR_LB_EX ;
            break;
        case   FUNC3_INSTR_LH  :
            //rv_core->execute_cb =instr_LH;
            rv_core->execute_instr =INSTR_LH_EX ;
            break;
        case   FUNC3_INSTR_LW  :
            //rv_core->execute_cb =instr_LW;
            rv_core->execute_instr =INSTR_LW_EX ;
            break;
        case   FUNC3_INSTR_LBU  :
            //rv_core->execute_cb =instr_LBU;
            rv_core->execute_instr =INSTR_LBU_EX ;
            break;
        case   FUNC3_INSTR_LHU  :
            //rv_core->execute_cb =instr_LHU;
            rv_core->execute_instr =INSTR_LHU_EX ;
            break;
    ...
    case   INSTR_SB_SH_SW_SD  :
    {
        ...
        int32_t next_subcode = -1;
        S_type_preparation(rv_core, &next_subcode);

        switch ( next_subcode )
        {

        case   FUNC3_INSTR_SB  :
            //rv_core->execute_cb =instr_SB;
            rv_core->execute_instr =INSTR_SB_EX;
            break;
        case   FUNC3_INSTR_SH  :
            //rv_core->execute_cb =instr_SH;
            rv_core->execute_instr =INSTR_SH_EX;
            break;
        case   FUNC3_INSTR_SW  :
            //rv_core->execute_cb =instr_SW;
            rv_core->execute_instr =INSTR_SW_EX;
            break;
    ...
    case   INSTR_ADDI_SLTI_SLTIU_XORI_ORI_ANDI_SLLI_SRLI_SRAI  :
    {
        ...
        case   FUNC3_INSTR_ADDI  :
            //rv_core->execute_cb =instr_ADDI;
            rv_core->execute_instr =INSTR_ADDI_EX;
            break;
        case   FUNC3_INSTR_SLTI  :
            //rv_core->execute_cb =instr_SLTI;
            rv_core->execute_instr =INSTR_SLTI_EX;
            break;
        case   FUNC3_INSTR_SLTIU  :
            //rv_core->execute_cb =instr_SLTIU;
            rv_core->execute_instr =INSTR_SLTIU_EX;
            break;
        case   FUNC3_INSTR_XORI  :
            //rv_core->execute_cb =instr_XORI;
            rv_core->execute_instr =INSTR_XORI_EX;
            break;
        case   FUNC3_INSTR_ORI  :
            //rv_core->execute_cb =instr_ORI;
            rv_core->execute_instr =INSTR_ORI_EX;
            break;
        case   FUNC3_INSTR_ANDI  :
            //rv_core->execute_cb =instr_ANDI;
            rv_core->execute_instr =INSTR_ANDI_EX;
            break;
        case   FUNC3_INSTR_SLLI  :
            //rv_core->execute_cb =instr_SLLI;
            rv_core->execute_instr =INSTR_SLLI_EX;
            break;
        case   FUNC3_INSTR_SRLI_SRAI  :
        {
            preparation_func7(rv_core,&next_subcode2) ;
            switch (next_subcode2 )
            {
            case FUNC7_INSTR_SRLI :
                //rv_core->execute_cb = instr_SRLI ;
                rv_core->execute_instr = INSTR_SRLI_F7_EX ;
                break ;
            case FUNC7_INSTR_SRAI :
                //rv_core->execute_cb = instr_SRAI ;
                rv_core->execute_instr = INSTR_SRAI_F7_EX ;
    ...
    case INSTR_ADD_SUB_SLL_SLT_SLTU_XOR_SRL_SRA_OR_AND_MUL_MULH_MULHSU_MULHU_DIV_DIVU_REM_REMU :
    {
        ...
        int32_t next_subcode = -1;
        R_type_preparation(rv_core, &next_subcode);
        int32_t next_subcode2 = -1;
        switch ( next_subcode )
        {
        ...
        case   FUNC3_INSTR_ADD_SUB_MUL  :
        {
            ...
            case FUNC7_INSTR_ADD :
                //rv_core->execute_cb = instr_ADD ;
                 rv_core->execute_instr = INSTR_ADD_EX;
                break ;
            case FUNC7_INSTR_SUB :
                //rv_core->execute_cb = instr_SUB ;
                rv_core->execute_instr = INSTR_SUB_EX;
                break;
#ifdef MULTIPLY_SUPPORT
            case FUNC7_INSTR_MUL :
                //rv_core->execute_cb = instr_MUL ;
                rv_core->execute_instr = INSTR_MUL_EX;
        ...
        case   FUNC3_INSTR_SLL_MULH  :
        {
            ...
            case FUNC7_INSTR_SLL :
                //rv_core->execute_cb = instr_SLL ;
                rv_core->execute_instr = INSTR_SLL_EX;
                break ;

#ifdef MULTIPLY_SUPPORT
            case FUNC7_INSTR_MUL :
                //rv_core->execute_cb = instr_MULH ;
                rv_core->execute_instr = INSTR_MUL_EX;
        ...
        case   FUNC3_INSTR_SLT_MULHSU  :
        {
            ...
            case FUNC7_INSTR_SLT :
                //rv_core->execute_cb = instr_SLT ;
                rv_core->execute_instr = INSTR_SLT_EX ;
                break ;

#ifdef MULTIPLY_SUPPORT
            case FUNC7_INSTR_MULHSU :
                //rv_core->execute_cb = instr_MULHSU ;
                rv_core->execute_instr = INSTR_MULHSU_EX ;
                break ;
#endif
            }
            break;
        ...
        case   FUNC3_INSTR_SLTU_MULHU  :
        {
            ...
            case FUNC7_INSTR_SLTU :
                //rv_core->execute_cb = instr_SLTU ;
                rv_core->execute_instr = INSTR_SLTU_EX ;
                break ;

#ifdef MULTIPLY_SUPPORT
            case FUNC7_INSTR_MULHU :
                //rv_core->execute_cb = instr_MULHU ;
                rv_core->execute_instr = INSTR_MULHU_EX ;
                break ;
#endif
            }
            break;
        ...
        case   FUNC3_INSTR_XOR_DIV  :
        {
            ...
            case FUNC7_INSTR_XOR :
                //rv_core->execute_cb = instr_XOR ;
                rv_core->execute_instr = INSTR_XOR_EX ;
                break ;

#ifdef MULTIPLY_SUPPORT
            case FUNC7_INSTR_DIV :
               // rv_core->execute_cb = instr_DIV ;
                rv_core->execute_instr = INSTR_DIV_EX ;
                break ;
#endif
            }
            break;
        ...
        case   FUNC3_INSTR_SRL_SRA_DIVU  :
        {
            ...
            case FUNC7_INSTR_SRL :
               // rv_core->execute_cb = instr_SRL ;
                rv_core->execute_instr = INSTR_SRL_EX ;
                break ;
            case FUNC7_INSTR_SRA :
               // rv_core->execute_cb = instr_SRA ;
                rv_core->execute_instr = INSTR_SRA_EX ;
                break ;

#ifdef MULTIPLY_SUPPORT
            case FUNC7_INSTR_DIVU :
               // rv_core->execute_cb = instr_DIVU ;
                rv_core->execute_instr = INSTR_DIVU_EX ;
        ...
        case   FUNC3_INSTR_OR_REM  :
        {
            ...
            {
            case FUNC7_INSTR_OR :
               // rv_core->execute_cb = instr_OR ;
                rv_core->execute_instr = INSTR_OR_EX ;
            ...
            case FUNC7_INSTR_REM :
               // rv_core->execute_cb = instr_REM ;
                rv_core->execute_instr = INSTR_REM_EX ;
        ...
        case   FUNC3_INSTR_AND_REMU  :
        {
            ...
            case FUNC7_INSTR_AND :
               //rv_core->execute_cb = instr_AND ;
                rv_core->execute_instr = INSTR_AND_EX ;
                break ;


#ifdef MULTIPLY_SUPPORT
            case FUNC7_INSTR_REMU :
              //  rv_core->execute_cb = instr_REMU ;
                rv_core->execute_instr = INSTR_REMU_EX ;
                break ;
#endif
            }
            break;
    ...
    case INSTR_ECALL_EBREAK_MRET_SRET_URET_WFI_CSRRW_CSRRS_CSRRC_CSRRWI_CSRRSI_CSRRCI_SFENCEVMA :
    {
        ...
        case   FUNC3_INSTR_CSRRW  :
           // rv_core->execute_cb =instr_CSRRW;
            rv_core->execute_instr = INSTR_CSRRW_EX ;
            break;
        case   FUNC3_INSTR_CSRRS  :
            //rv_core->execute_cb =instr_CSRRS;
            rv_core->execute_instr = INSTR_CSRRS_EX ;
            break;
        case   FUNC3_INSTR_CSRRC  :
          //  rv_core->execute_cb =instr_CSRRC;
            rv_core->execute_instr = INSTR_CSRRC_EX ;
            break;
        case   FUNC3_INSTR_CSRRWI  :
           // rv_core->execute_cb =instr_CSRRWI;
            rv_core->execute_instr = INSTR_CSRRWI_EX ;
            break;
        case   FUNC3_INSTR_CSRRSI  :
           // rv_core->execute_cb =instr_CSRRSI;
            rv_core->execute_instr = INSTR_CSRRSI_EX ;
            break;
        case   FUNC3_INSTR_CSRRCI  :
            //rv_core->execute_cb =instr_CSRRCI;
            rv_core->execute_instr = INSTR_CSRRCI_EX ;
            break;
        case   FUNC3_INSTR_ECALL_EBREAK_MRET_SRET_URET_WFI_SFENCEVMA  :
        {
            ...
            {
                preparation_func7_func12_sub5_extended  (rv_core,&next_subcode3) ;
                ...
                {
                   // rv_core->execute_cb = instr_ECALL ;
                    rv_core->execute_instr = INSTR_ECALL_EX ;
                    break ;
                }
                case FUNC5_INSTR_EBREAK :
                {
                   // rv_core->execute_cb = instr_EBREAK ;
                    rv_core->execute_instr = INSTR_EBREAK_EX ;
                    break ;
                }
                case FUNC5_INSTR_URET :
                {
                   // rv_core->execute_cb = instr_URET ;
                    rv_core->execute_instr = INSTR_URET_EX ;
                    break ;
                }
                }
            ...
            case FUNC7_INSTR_SRET_WFI :
            {
                ...
                {
                    //rv_core->execute_cb = instr_SRET ;
                    rv_core->execute_instr = INSTR_SRET_EX ;
                    break ;
                }
            ...
            {
                //rv_core->execute_cb = instr_MRET ;
                rv_core->execute_instr = INSTR_MRET_EX ;
                break ;
            }
    ...
    case INSTR_AMO_W_D_LR_SC_SWAP_ADD_XOR_AND_OR_MIN_MAX_MINU_MAXU :
    {
        ...
        {
            preparation_func5(rv_core,&next_subcode2) ;

            switch (next_subcode2 )
            {
            case FUNC5_INSTR_AMO_LR :
            {
               // rv_core->execute_cb = instr_LR_W ;
                rv_core->execute_instr = INSTR_AMO_LR_EX ;
                break ;
            }

            case FUNC5_INSTR_AMO_SC :
            {
                //rv_core->execute_cb = instr_SC_W ;
                rv_core->execute_instr = INSTR_AMO_SC_EX ;
                break ;
            }
            case FUNC5_INSTR_AMO_SWAP :
            {
               // rv_core->execute_cb = instr_AMOSWAP_W ;
                rv_core->execute_instr = INSTR_AMO_SWAP_EX ;
                break ;
            }
            case FUNC5_INSTR_AMO_ADD :
            {
                //rv_core->execute_cb = instr_AMOADD_W ;
                rv_core->execute_instr = INSTR_AMO_ADD_EX ;
                break ;
            }
            case FUNC5_INSTR_AMO_XOR :
            {
               // rv_core->execute_cb = instr_AMOXOR_W ;
                rv_core->execute_instr = INSTR_AMO_XOR_EX ;
                break ;
            }
            case FUNC5_INSTR_AMO_AND :
            {
                //rv_core->execute_cb = instr_AMOAND_W ;
                rv_core->execute_instr = INSTR_AMO_AND_EX ;
                break ;
            }
            case FUNC5_INSTR_AMO_OR :
            {
               // rv_core->execute_cb = instr_AMOOR_W ;
                rv_core->execute_instr = INSTR_AMO_OR_EX ;
                break ;
            }
            case FUNC5_INSTR_AMO_MIN :
            {
               // rv_core->execute_cb = instr_AMOMIN_W ;
                rv_core->execute_instr = INSTR_AMO_MIN_EX ;
                break ;
            }

            case FUNC5_INSTR_AMO_MAX :
            {
              //  rv_core->execute_cb = instr_AMOMAX_W ;
                rv_core->execute_instr = INSTR_AMO_MAX_EX ;
                break ;
            }
            case FUNC5_INSTR_AMO_MINU :
            {
               // rv_core->execute_cb = instr_AMOMINU_W ;
                rv_core->execute_instr = INSTR_AMO_MINU_EX ;
                break ;
            }
            case FUNC5_INSTR_AMO_MAXU :
            {
              //  rv_core->execute_cb = instr_AMOMAXU_W ;
                rv_core->execute_instr = INSTR_AMO_MAXU_EX ;
                break ;
            }
            }
...
static rv_uint_xlen rv_core_execute(rv_core_td *rv_core)
{
  ...
  //              break;
    ...
    case INSTR_CSRRWI_EX:
        instr_CSRRWI(rv_core);
                break;
    case INSTR_CSRRSI_EX:
        instr_CSRRSI(rv_core);
                break;
    case INSTR_CSRRCI_EX:
        instr_CSRRCI(rv_core);
                break;
...
//    /* Atomic Instructions */
    ...
    case INSTR_AMO_SWAP_EX:
        instr_AMOSWAP_W(rv_core);
                break;
    case INSTR_AMO_ADD_EX:
        instr_AMOADD_W(rv_core);
                break;
    case INSTR_AMO_XOR_EX:
        instr_AMOXOR_W(rv_core);
                break;
    case INSTR_AMO_AND_EX:
        instr_AMOAND_W(rv_core);
                break;
    case INSTR_AMO_OR_EX:
        instr_AMOOR_W(rv_core);
                break;
    case INSTR_AMO_MIN_EX:
        instr_AMOMIN_W(rv_core);
                break;
    case INSTR_AMO_MAX_EX:
        instr_AMOMAX_W(rv_core);
                break;
    case INSTR_AMO_MINU_EX:
        instr_AMOMINU_W(rv_core);
                break;
    case INSTR_AMO_MAXU_EX:
        instr_AMOMAXU_W(rv_core);
                break;
